        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button
                onClick={onClose}
                className="mt-6 w-full px-6 py-3.5 border border-stone-800 text-stone-900 rounded-lg text-sm font-bold uppercase tracking-widest transition-all duration-300 hover:bg-stone-900 hover:text-stone-100 hover:shadow-lg active:shadow-md active:scale-95"
              >
                Continue Shopping
              </button>
            </div>
        ...
        {items.length > 0 && (
          <div className="sticky bottom-0 bg-surface border-t border-surface-variant px-6 py-6 space-y-4">
            ...
            <button
              ...
              className="w-full py-3.5 border border-stone-800 text-stone-900 rounded-lg text-sm tracking-widest font-bold uppercase transition-all duration-300 hover:bg-stone-900 hover:text-stone-100 hover:shadow-lg active:shadow-md active:scale-95"
            >
